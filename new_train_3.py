...
from new_utlis_3 import normalize_row, normalize_col, test_model, node_probability, edge_probability
from new_model_3 import Model
...
parser.add_argument('--test_rate', type=float, default = 0.9, help='Epoch interval to run test set.')
